...
class Contact extends Model
{
    ...
    {
        return $this->hasMany(Appointment::class)->orderBy('start_datetime', 'desc');
    }
    ...
    {
        return $this->belongsTo(InvoiceClient::class, 'id', 'contact_id');
    }

    public function invoices(): HasMany
    {
        return $this->hasMany(ClientInvoice::class, 'invoice_client_id', 'id')
